...
Set_config_port(){
	...
	read -e -p "(默认: 2048):" ssr_port
	[[ -z "$ssr_port" ]] && ssr_port="2048"
...
Set_config_password(){
	...
	read -e -p "(默认: antonywilson.club):" ssr_password
	[[ -z "${ssr_password}" ]] && ssr_password="antonywilson.club"
